...
#   3. Container runs as non-root user 'copilot'
...
# ── 10. Auth banner — unauthenticated path ────────────────────────────────────

echo "── 10. Testing auth status detection..."
...
# ── 11. proxy denied command ──────────────────────────────────────────────────

echo "── 11. Testing proxy denied command..."
